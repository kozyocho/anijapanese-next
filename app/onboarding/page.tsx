        ...
        return (
            <div style={{ minHeight: '100dvh', padding: '0 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
                ...
                <div style={{ textAlign: 'center', padding: '32px 0 0' }}>
                    <h1 style={{ fontSize: 'clamp(1.6rem,6vw,2rem)', fontWeight: 700, lineHeight: 1.2, letterSpacing: '-0.03em', margin: '0 0 12px' }}>
                        Learn Japanese<br />the anime way
                    </h1>
                    <p style={{ color: 'rgba(235,235,245,0.6)', fontSize: '1rem', margin: '0 0 32px', lineHeight: 1.6 }}>
                    ...
                    <p style={{ marginTop: '12px', fontSize: '0.78rem', color: 'rgba(235,235,245,0.3)' }}>
        ...
        return (
            <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', padding: '0 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
                    <h2 style={{ fontSize: '1.8rem', fontWeight: 700, letterSpacing: '-0.02em', margin: '0 0 20px' }}>
                        Your plan is ready!
                    </h2>
                    <div style={{
                        background: '#1C1C1E', border: '1px solid rgba(84,84,88,0.6)',
                        ...
                        {[
                            ...
                            <div key={row.label} style={{
                                ...
                                padding: '10px 0',
                                borderBottom: i < arr.length - 1 ? '1px solid rgba(84,84,88,0.4)' : 'none',
                            }}>
                                <span style={{ fontSize: '0.8rem', color: 'rgba(235,235,245,0.45)', width: '80px', flexShrink: 0 }}>{row.label}</span>
                                <span style={{ fontSize: '0.9rem', fontWeight: 700, color: '#FFFFFF' }}>{row.value}</span>
                            </div>
                        ))}
                    </div>
                    <p style={{ color: 'rgba(235,235,245,0.6)', fontSize: '0.9rem', margin: '0 0 28px', lineHeight: 1.7 }}>
        ...
        return (
            <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', padding: '24px 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <h2 style={{ fontSize: 'clamp(1.4rem,5vw,1.8rem)', fontWeight: 700, lineHeight: 1.2, letterSpacing: '-0.02em', margin: '0 0 8px' }}>
                        Pick your level
                    </h2>
                    <p style={{ color: 'rgba(235,235,245,0.6)', fontSize: '0.95rem', margin: '0 0 28px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        {LEVEL_RESULTS.map(lv => (
                            <button key={lv.level} onClick={() => { setDetectedLevel(lv); setScreen('time') }} style={{
                                ...
                                padding: '16px 18px', background: '#1C1C1E',
                                border: '1.5px solid rgba(84,84,88,0.5)',
                                borderRadius: '14px', color: '#FFFFFF', fontFamily: 'inherit',
                                fontSize: '0.95rem', fontWeight: 600, cursor: 'pointer',
                                textAlign: 'left', transition: 'border-color 0.15s, background 0.15s',
                            }}
                                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(10,132,255,0.5)'; e.currentTarget.style.background = 'rgba(10,132,255,0.08)' }}
                                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(84,84,88,0.5)'; e.currentTarget.style.background = '#1C1C1E' }}
                            >
                                <span style={{
                                ...
                                <div>
                                    <div>{lv.display}</div>
                                    <div style={{ fontSize: '0.78rem', color: 'rgba(235,235,245,0.45)', fontWeight: 400, marginTop: '2px' }}>{lv.sub}</div>
                                </div>
                            </button>
                        ))}
                    </div>
    ...
    if (screen === 'placement') {
        ...
        if (placementDone && detectedLevel) {
            return (
                <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', padding: '24px 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
                        <h2 style={{ fontSize: '1.6rem', fontWeight: 700, margin: '0 0 8px' }}>Your level is set!</h2>
                        <p style={{ color: 'rgba(235,235,245,0.6)', margin: '0 0 20px' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: '2.2rem', fontWeight: 700, color: '#409CFF', marginBottom: '4px' }}>
                                {detectedLevel.display}
                            </div>
                            <div style={{ fontSize: '0.85rem', color: 'rgba(235,235,245,0.45)' }}>
                                {detectedLevel.sub}
                            </div>
                        </div>
        ...
        return (
            <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', padding: '24px 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <div style={{ fontSize: '0.78rem', color: 'rgba(235,235,245,0.3)', fontWeight: 700, marginBottom: '24px', textAlign: 'center' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: '0.65rem', color: '#0A84FF', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '16px' }}>
                            What does this mean?
                        </div>
                        <div style={{ fontSize: 'clamp(3rem,10vw,4.5rem)', fontWeight: 700, marginBottom: '8px' }}>{q.jp}</div>
                        <div style={{ fontSize: '0.9rem', color: 'rgba(235,235,245,0.45)' }}>{q.reading}</div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                        {q.opts.map(opt => {
                            ...
                            const bg = selected
                                ? isCorrect ? 'rgba(48,209,88,0.2)' : isSelected ? 'rgba(255,69,58,0.15)' : '#1C1C1E'
                                : '#1C1C1E'
                            const border = selected
                                ? isCorrect ? '1.5px solid #30D158' : isSelected ? '1.5px solid #FF453A' : '1.5px solid rgba(84,84,88,0.5)'
                                : '1.5px solid rgba(84,84,88,0.6)'
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '6px', marginTop: '28px' }}>
                        {PLACEMENT_QUESTIONS.map((_, i) => (
                            <div key={i} style={{
                                ...
                                background: i < qIndex ? '#0A84FF' : i === qIndex ? '#409CFF' : 'rgba(84,84,88,0.65)',
                    ...
                    <button onClick={() => setScreen('level-pick')} style={{
                        ...
                        color: 'rgba(235,235,245,0.45)', fontFamily: 'inherit', fontSize: '0.82rem',
    ...
    return (
        <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', padding: '24px 20px 40px', maxWidth: '480px', margin: '0 auto' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <p style={{ color: 'rgba(235,235,245,0.6)', fontSize: '0.95rem', margin: '0 0 28px' }}>{sub}</p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    {options.map(opt => (
                        <button key={opt.value} onClick={() => !saving && onPick(opt.value)} disabled={saving} style={{
                            ...
                            onMouseEnter={e => { if (!saving) { e.currentTarget.style.borderColor = 'rgba(10,132,255,0.5)'; e.currentTarget.style.background = 'rgba(10,132,255,0.08)' } }}
                            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(84,84,88,0.5)'; e.currentTarget.style.background = '#1C1C1E' }}
                        >
                            <div>
                                <div>{opt.label}</div>
                                <div style={{ fontSize: '0.78rem', color: 'rgba(235,235,245,0.45)', fontWeight: 400, marginTop: '2px' }}>{opt.sub}</div>
                            </div>
                        </button>
                    ))}
                </div>
...
function ProgressBar({ progress, step, total, onBack }: { progress: number; step: number; total: number; onBack?: () => void }) {
    return (
        <div style={{ marginBottom: '40px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.78rem', color: 'rgba(235,235,245,0.45)', marginBottom: '8px', fontWeight: 600 }}>
                <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    {onBack && (
                        <button onClick={onBack} aria-label="Back" style={{
                            background: 'none', border: 'none', color: 'rgba(235,235,245,0.45)',
